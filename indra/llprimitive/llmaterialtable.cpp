...
F32 const LLMaterialTable::FRICTION_GLASS 	= 0.13f;
F32 const LLMaterialTable::FRICTION_LIGHT 	= 0.14f;
F32 const LLMaterialTable::FRICTION_METAL 	= 0.22f;
F32 const LLMaterialTable::FRICTION_PLASTIC	= 0.3f;
F32 const LLMaterialTable::FRICTION_WOOD 	= 0.44f;
F32 const LLMaterialTable::FRICTION_FLESH 	= 0.46f;
F32 const LLMaterialTable::FRICTION_LAND 	= 0.58f;
F32 const LLMaterialTable::FRICTION_STONE 	= 0.6f;
...
F32 const LLMaterialTable::RESTITUTION_FLESH 	= 0.2f;
F32 const LLMaterialTable::RESTITUTION_STONE 	= 0.4f;
F32 const LLMaterialTable::RESTITUTION_METAL 	= 0.4f;
F32 const LLMaterialTable::RESTITUTION_WOOD 	= 0.5f;
F32 const LLMaterialTable::RESTITUTION_GLASS 	= 0.7f;
F32 const LLMaterialTable::RESTITUTION_PLASTIC	= 0.7f;
...
void LLMaterialTable::initBasicTable()
{
	...
	addDamageAndEnergy(LL_MCODE_STONE, 1.f, 1.f, 1.f);
	addDamageAndEnergy(LL_MCODE_METAL, 1.f, 1.f, 1.f);
	addDamageAndEnergy(LL_MCODE_GLASS, 1.f, 1.f, 1.f);
	addDamageAndEnergy(LL_MCODE_WOOD, 1.f, 1.f, 1.f);
	addDamageAndEnergy(LL_MCODE_FLESH, 1.f, 1.f, 1.f);
	addDamageAndEnergy(LL_MCODE_PLASTIC, 1.f, 1.f, 1.f);
	addDamageAndEnergy(LL_MCODE_RUBBER, 1.f, 1.f, 1.f);
	addDamageAndEnergy(LL_MCODE_LIGHT, 1.f, 1.f, 1.f);
	addFriction(LL_MCODE_STONE,0.8f);
	addFriction(LL_MCODE_METAL,0.3f);
	addFriction(LL_MCODE_GLASS,0.2f);
	addFriction(LL_MCODE_WOOD,0.6f);
	addFriction(LL_MCODE_FLESH,0.9f);
	addFriction(LL_MCODE_PLASTIC,0.4f);
	addFriction(LL_MCODE_RUBBER,0.9f);
	addFriction(LL_MCODE_LIGHT,0.2f);
	addRestitution(LL_MCODE_STONE,0.4f);
	addRestitution(LL_MCODE_METAL,0.4f);
	addRestitution(LL_MCODE_GLASS,0.7f);
	addRestitution(LL_MCODE_WOOD,0.5f);
	addRestitution(LL_MCODE_FLESH,0.3f);
	addRestitution(LL_MCODE_PLASTIC,0.7f);
