...
public:
	...
	const LLVolume *getVolumeConst() const { return mVolumep; }
	...
	S32 unpackTEMessage(LLMessageSystem* mesgsys, char const* block_name, const S32 block_num);
...
protected:
	...
	LLPrimTextureList	mTextureList;
	U8					mMaterial;
	U8					mNumTEs;
	U32 				mMiscFlags;
