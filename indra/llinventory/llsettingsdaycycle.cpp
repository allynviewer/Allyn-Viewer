...
const LLSettingsDay::Seconds LLSettingsDay::MINIMUM_DAYLENGTH(14400);
const LLSettingsDay::Seconds LLSettingsDay::DEFAULT_DAYLENGTH(14400);
const LLSettingsDay::Seconds LLSettingsDay::MAXIMUM_DAYLENGTH(604800);
const LLSettingsDay::Seconds LLSettingsDay::MINIMUM_DAYOFFSET(0);
const LLSettingsDay::Seconds LLSettingsDay::DEFAULT_DAYOFFSET(57600);
const LLSettingsDay::Seconds LLSettingsDay::MAXIMUM_DAYOFFSET(86400);
const S32 LLSettingsDay::TRACK_WATER(0);
const S32 LLSettingsDay::TRACK_GROUND_LEVEL(1);
const S32 LLSettingsDay::TRACK_MAX(5);
