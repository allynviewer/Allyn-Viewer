...
{
	return !mIsGroupOwned && requester == mOwner &&
	  (requester == mCreator ||
	   (export_policy == ep_export_bit && (mMaskEveryone & PERM_EXPORT)) ||
	   (export_policy == ep_full_perm && (mMaskOwner & PERM_ITEM_UNRESTRICTED) == PERM_ITEM_UNRESTRICTED));
}
