...
public:
    ...
    virtual void            switchTrack(S32 trackno, const LLSettingsBase::TrackPosition& position) { }
protected:
...
public:
    ...
    inline void setTimeDeltaThreshold(const LLSettingsBase::Seconds time)
    {
        ...
        mTimeDeltaPassed = time + LLSettingsBase::Seconds(1.0);
    }
