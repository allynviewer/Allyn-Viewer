...
LLKeyboardWin32::LLKeyboardWin32()
{
	...
	mTranslateNumpadMap[0x60] = KEY_PAD_INS;
	mTranslateNumpadMap[0x61] = KEY_PAD_END;
	mTranslateNumpadMap[0x62] = KEY_PAD_DOWN;
	mTranslateNumpadMap[0x63] = KEY_PAD_PGDN;
	mTranslateNumpadMap[0x64] = KEY_PAD_LEFT;
	mTranslateNumpadMap[0x65] = KEY_PAD_CENTER;
	mTranslateNumpadMap[0x66] = KEY_PAD_RIGHT;
	mTranslateNumpadMap[0x67] = KEY_PAD_HOME;
	mTranslateNumpadMap[0x68] = KEY_PAD_UP;
	mTranslateNumpadMap[0x69] = KEY_PAD_PGUP;
	mTranslateNumpadMap[0x6A] = KEY_PAD_MULTIPLY;
	mTranslateNumpadMap[0x6B] = KEY_PAD_ADD;
	mTranslateNumpadMap[0x6D] = KEY_PAD_SUBTRACT;
	mTranslateNumpadMap[0x6E] = KEY_PAD_DEL;
	mTranslateNumpadMap[0x6F] = KEY_PAD_DIVIDE;
