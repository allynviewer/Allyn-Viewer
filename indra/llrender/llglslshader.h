...
public:
	...
	LLStaticStringTable<GLint> mUniformMap;
	std::map<GLint, std::string> mUniformNameMap;
	std::vector<std::pair<GLint, LLVector4> > mValueVec4;
	std::vector<std::pair<GLint, LLMatrix3> > mValueMat3;
	std::vector<std::pair<GLint, LLMatrix4> > mValueMat4;
