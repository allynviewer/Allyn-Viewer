...
DISPLAY_GAMMA,
	...
	virtual bool attachClassSharedShaders(LLGLSLShader& shader, S32 shader_class) = 0;
public:
	...
	std::multimap<std::string, CachedObjectInfo > mShaderObjects;
...
public:
	...
	static std::vector<LLGLSLShader *> &getGlobalShaderList();
};
#endif
