...
public:
	...
	LLColor3(const char *color_string);
	explicit LLColor3(const LLColor4& color4);
	explicit LLColor3(const LLVector4& vector4);
	...
	const LLColor3&	set(F32 x, F32 y, F32 z);
	const LLColor3&	set(const LLColor3 &vec);
	const LLColor3&	set(const F32 *vec);
	F32		magVec() const;
...
#endif
inline LLColor3::LLColor3(const char* color_string)
{
