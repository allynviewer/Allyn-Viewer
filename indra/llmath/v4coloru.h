...
public:
	...
	const LLColor4U&	setToBlack();
	const LLColor4U&	setToWhite();
	const LLColor4U&	set(U8 r, U8 g, U8 b, U8 a);
	const LLColor4U&	set(U8 r, U8 g, U8 b);
	const LLColor4U&	set(const LLColor4U &vec);
	const LLColor4U&	set(const U8 *vec);
	const LLColor4U&	setVec(U8 r, U8 g, U8 b, U8 a);
	const LLColor4U&	setVec(U8 r, U8 g, U8 b);
	const LLColor4U&	setVec(const LLColor4U &vec);
