...
public:
	...
	virtual S32 writeState(U8 **dest, U32 header_size, U32 footer_size) = 0;
	virtual U32 getEventsSavedSize() = 0;
	virtual S32 writeEvents(U8 *dest) = 0;
	virtual void readEvents(U8* src, S32& offset) = 0;
	virtual S32 readState(U8 *src) = 0;
	virtual void reset();
...
public:
	...
	virtual S32 writeState(U8 **dest, U32 header_size, U32 footer_size);
