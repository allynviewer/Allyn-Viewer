...
public:
	...
	std::string getCurrentElementName() { return LLStringUtil::null; }
	std::string getCurrentFileName() { return LLStringUtil::null; }
	LLXSDWriter();
	~LLXSDWriter();
protected:
...
public:
	...
	std::string getCurrentFileName() { return mCurFileName; }
...
private:
	LLXUIParser(const LLXUIParser& other);
