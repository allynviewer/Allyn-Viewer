...
public:
	...
	void			setMaxTitleWidth(S32 max_width) { mMaxTitleWidth = max_width; }
	S32				getMaxTitleWidth() const { return mMaxTitleWidth; }
	void			setTitleVisible(BOOL visible);
	virtual void	setTitle( const std::string& title ) = 0;
	virtual const std::string&	getTitle() const = 0;
	virtual void	setTitleIcon(const std::string& image_name);
	const std::string& getTitleIcon() const { return mTitleIcon; }
