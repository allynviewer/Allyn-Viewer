...
public:
	...
	void			setKeyboardFocus(LLFocusableElement* new_focus, BOOL lock = FALSE, BOOL keystrokes_only = FALSE);
...
private:
	...
	LLFocusableElement*	mLastKeyboardFocus;
