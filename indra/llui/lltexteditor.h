...
public:
	...
	BOOL	isSpellDirty() const { return mWText != mPrevSpelledText; }
	void	resetSpellDirty() { mPrevSpelledText = mWText; }
	virtual void	undo();
	...
	LLMenuGL*		createUrlContextMenu(S32 x, S32 y, const std::string &url);
