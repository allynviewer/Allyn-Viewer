...
public:
	...
	void				apply( ESex sex );
	char const*			getTypeString(void) const { return "param_skeleton"; }
	F32					getTotalDistortion() { return 0.1f; }
	const LLVector4a&	getAvgDistortion()	{ return mDefaultVec; }
	F32					getMaxDistortion() { return 0.1f; }
	LLVector4a			getVertexDistortion(S32 index, LLPolyMesh *poly_mesh){return LLVector4a(0.001f, 0.001f, 0.001f);}
	const LLVector4a*	getFirstDistortion(U32 *index, LLPolyMesh **poly_mesh){index = 0; poly_mesh = NULL; return &mDefaultVec;};
