...
public:
	...
	void				stopAnimating(bool upload_bake = false);
	BOOL				linkDrivenParams(visual_param_mapper mapper, BOOL only_cross_params);
	void				resetDrivenParams();
	char const*			getTypeString(void) const { return "param_driver"; }
