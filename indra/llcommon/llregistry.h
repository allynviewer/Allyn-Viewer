...
public:
	...
	typedef typename boost::add_reference<typename std::add_const<KEY>::type>::type	ref_const_key_t;
	typedef typename boost::add_reference<typename std::add_const<VALUE>::type>::type	ref_const_value_t;
	typedef typename boost::add_reference<VALUE>::type									ref_value_t;
	typedef typename boost::add_pointer<typename std::add_const<VALUE>::type>::type	ptr_const_value_t;
