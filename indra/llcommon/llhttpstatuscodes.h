...
const S32 HTTP_INTERNAL_ERROR_LOW_SPEED = 494;
const S32 HTTP_INTERNAL_ERROR_CURL_LOCKUP = 495;
const S32 HTTP_INTERNAL_ERROR_CURL_BADSOCKET = 496;
const S32 HTTP_INTERNAL_ERROR_CURL_TIMEOUT = 497;
const S32 HTTP_INTERNAL_ERROR_CURL_OTHER = 498;
const S32 HTTP_INTERNAL_ERROR_OTHER = 499;
