...
namespace tut
{
	...
	void string_index_object_t::test<1>()
	{
		...
		std::string llstr9("Hello World", sizeof("Hello World")-1, 5);
	...
	{
		F64 value;
		std::string str_val("9223372036854775807");
