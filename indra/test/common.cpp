...
namespace tut
{
	...
	void U64_object::test<1>()
	{
		...
		U64_to_str(val, result, sizeof("18446744073709551615"));
		result_str = (const char*) result;
		ensure_equals("U64_to_str converted 1.8", val_str, result_str);
		val = U64L(18446744073709551615);
		val_str = "1844";
		memset(result, 'A', sizeof(result));
		U64_to_str(val, result, 5);
		result_str = (const char*) result;
	...
	void U64_object::test<3>()
	{
		...
		result = U64L(0x7FFFFFFFFFFFFFFF) * 1.0L;
