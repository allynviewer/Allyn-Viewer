...
void gSetInitDataDefaults(LLPartInitData *setMe)
{
	...
	setMe->killPlaneNormal[0] = 0.0f;setMe->killPlaneNormal[1] = 0.0f;setMe->killPlaneNormal[2] = 1.0f;
	setMe->killPlaneZ = 0.0f;
	setMe->bouncePlaneNormal[0] = 0.0f;setMe->bouncePlaneNormal[1] = 0.0f;setMe->bouncePlaneNormal[2] = 1.0f;
	setMe->bouncePlaneZ = 0.0f;
	setMe->spawnRange = 1.0f;
	setMe->spawnFrequency = 0.0f;
	setMe->spawnFreqencyRange = 0.0f;
	setMe->spawnDirection[0] = 0.0f;setMe->spawnDirection[1] = 0.0f;setMe->spawnDirection[2] = 1.0f;
	setMe->spawnDirectionRange = 1.0f;
	setMe->spawnVelocity = 0.75f;
	setMe->spawnVelocityRange = 0.25f;
	setMe->speedLimit = 1.0f;
	setMe->windWeight = 0.5f;
	setMe->currentGravity[0] = 0.0f;setMe->currentGravity[1] = 0.0f;setMe->currentGravity[2] = -9.81f;
	setMe->gravityWeight = 0.5f;
	setMe->globalLifetime = 0.0f;
	setMe->individualLifetime = 5.0f;
	setMe->individualLifetimeRange = 1.0f;
	setMe->alphaDecay = 1.0f;
	setMe->scaleDecay = 0.0f;
	setMe->distanceDeath = 10.0f;
...
U32 LLPartSysCompressedPacket::writeUUID(LLPartInitData *in, U32 startByte)
{
	...
	mData[startByte++] = 0x00;
	memcpy(bufPtr, in->mImageUuid.mData, 16);
	return (startByte+16);
}
...
U32 LLPartSysCompressedPacket::readUUID(LLPartInitData *in, U32 startByte)
{
	...
	startByte++;
	memcpy(in->mImageUuid.mData, bufPtr, 16);
	return (startByte+16);
}
