...
#define DDCN(x) (x)
#endif
      channel_ct viewer DDCN("VIEWER");
      channel_ct primbackup DDCN("PRIMBACKUP");
      channel_ct gtk DDCN("GTK");
      channel_ct sdl DDCN("SDL");
      channel_ct backtrace DDCN("BACKTRACE");
      channel_ct statemachine DDCN("STATEMACHINE");
      channel_ct caps DDCN("CAPS");
      channel_ct curl DDCN("CURL");
      channel_ct curlio DDCN("CURLIO");
      channel_ct curltr DDCN("CURLTR");
      channel_ct snapshot DDCN("SNAPSHOT");
    }
  }
  namespace {
