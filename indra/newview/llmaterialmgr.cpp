...
public:
	...
	AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return materialsResponder_timeout; }
	char const* getName(void) const { return "LLMaterialsResponder"; }
private:
	std::string      mMethod;
