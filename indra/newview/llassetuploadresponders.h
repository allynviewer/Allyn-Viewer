...
public:
	...
	virtual void uploadComplete(const LLSD& content);
	virtual void uploadFailure(const LLSD& content);
	char const* getName() const { return "LLNewAgentInventoryResponder"; }
protected:
	virtual void httpFailure();
};
...
public:
	...
	LLUpdateAgentInventoryResponder(const LLSD& post_data,
								const std::string& file_name,
											   LLAssetType::EType asset_type);
	virtual void uploadComplete(const LLSD& content);
	char const* getName() const { return "LLUpdateAgentInventoryResponder"; }
};
...
public:
	...
	LLUpdateTaskInventoryResponder(const LLSD& post_data,
								...
								LLAssetType::EType asset_type);
	virtual void uploadComplete(const LLSD& content);
	char const* getName() const { return "LLUpdateTaskInventoryResponder"; }
private:
	LLUUID mQueueId;
};
#endif
