...
public:
	...
	void recordHttpResult(S32 status, bool is_map_tile, S32 received_bytes);
	U32 getHttpOkCount() const { return mHttpOkCount; }
	U32 getHttpPartialCount() const { return mHttpPartialCount; }
	U32 getHttpForbiddenCount() const { return mHttpForbiddenCount; }
	U32 getHttpNotFoundCount() const { return mHttpNotFoundCount; }
	U32 getHttpOtherFailCount() const { return mHttpOtherFailCount; }
	U32 getHttpMapFailCount() const { return mHttpMapFailCount; }
	U32 getHttpTextureBytes() const { return mHttpTextureBytes; }
    S32 getPending();
...
private:
	...
	LLAtomicU32 mHttpOkCount;
	LLAtomicU32 mHttpPartialCount;
	LLAtomicU32 mHttpForbiddenCount;
	LLAtomicU32 mHttpNotFoundCount;
	LLAtomicU32 mHttpOtherFailCount;
	LLAtomicU32 mHttpMapFailCount;
	LLAtomicU32 mHttpTextureBytes;
public:
