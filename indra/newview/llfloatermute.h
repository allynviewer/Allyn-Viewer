...
private:
	...
	LLPointer<LLUIImage>	mAvatarIcon;
	LLPointer<LLUIImage>	mObjectIcon;
	LLPointer<LLUIImage>	mGroupIcon;
	LLPointer<LLUIImage>	mNameIcon;
	std::map<LLUUID, LLMute>	mMuteDict;
};
#endif
