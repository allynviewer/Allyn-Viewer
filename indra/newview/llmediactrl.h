...
public:
	...
	void onCopyURL() const;
		...
		void onShowSource();
		void setStretchToFill(bool stretch) { mStretchToFill = stretch; }
	void setMaintainAspectRatio(bool maintain) { mMaintainAspectRatio = maintain; }
	void setIgnoreUIScale(bool ignore);
	bool getIgnoreUIScale() const { return mIgnoreUIScale; }
	void setContentScale(F32 scale);
	F32 getContentScale() const { return mContentScale; }
	void setPageZoomOverride(F32 zoom);
