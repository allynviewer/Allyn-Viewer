...
class LLHomeLocationResponder : public LLHTTPClient::ResponderWithResult
{
	...
	AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return homeLocationResponder_timeout; }
	char const* getName(void) const { return "LLHomeLocationResponder"; }
};
#endif
