...
int LLEnvironmentRequestResponder::sCount = 0;
LLEnvironmentRequestResponder::LLEnvironmentRequestResponder()
{
	mID = ++sCount;
}
void LLEnvironmentRequestResponder::httpSuccess(void)
{
...
void LLEnvironmentRequestResponder::httpFailure(void)
{
...
void LLEnvironmentApplyResponder::httpSuccess(void)
{
...
void LLEnvironmentApplyResponder::httpFailure(void)
{
