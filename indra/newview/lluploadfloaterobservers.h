...
public:
	...
	AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return uploadModelPremissionsResponder_timeout; }
	char const* getName(void) const { return "LLUploadModelPremissionsResponder"; }
private:
