...
public:
	...
	U32 getVertexDataMask() { return VERTEX_DATA_MASK; }
	void render(S32 pass = 0) { }
	S32	 getNumPasses() {return 0;}
	void prerender();
	...
	void pushBatch(LLDrawInfo& params, U32 mask, BOOL texture, BOOL batch_textures = FALSE);
};
#endif
