...
static LL_ALIGN_16(const LLMatrix4a) OGL_TO_CFR_ROTATION(LLVector4a( 0.f,  0.f, -1.f,  0.f),
...
public:
	...
	void setView(F32 vertical_fov_rads);
...
protected:
	...
	mutable LLMatrix4a	mProjectionMatrix;
