...
protected:
	...
	char const* getName(void) const { return "LLAvatarPickerResponder"; }
};
...
void LLFloaterAvatarPicker::processAvatarPickerReply(LLMessageSystem* msg, void**)
{
	...
	for (S32 i = 0; i < num_new_rows; i++)
	{
		...
		if (avatar_id != agent_id || !floater->isExcludeAgentFromSearchResults())
		{
