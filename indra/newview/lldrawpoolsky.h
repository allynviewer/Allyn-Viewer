...
public:
	...
	S32 getNumPostDeferredPasses() { return getNumPasses(); }
	void beginPostDeferredPass(S32 pass) { beginRenderPass(pass); }
	void endPostDeferredPass(S32 pass) { endRenderPass(pass); }
