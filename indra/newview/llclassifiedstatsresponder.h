...
public:
	...
	AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return classifiedStatsResponder_timeout; }
	char const* getName(void) const { return "LLClassifiedStatsResponder"; }
protected:
