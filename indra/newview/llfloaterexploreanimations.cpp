...
void LLFloaterExploreAnimations::processAnim(LLUUID avatarid, LLUUID assetid, bool playing)
{
	...
	if(asset_str.find("17132261-c061") != std::string::npos) return;
	else if(asset_str.find("fea558cb-8b9b") != std::string::npos) return;
	else if(asset_str.find("50cb5750-0743") != std::string::npos) return;
