...
public:
	...
	char const* getName(void) const { return "NavMeshStatusResponder"; }
protected:
...
public:
	...
	char const* getName(void) const { return "NavMeshResponder"; }
protected:
	virtual void httpSuccess();
	virtual void httpFailure();
private:
...
public:
	...
	char const* getName(void) const { return "AgentStateResponder"; }
protected:
	virtual void httpSuccess();
	virtual void httpFailure();
};
...
public:
	...
	char const* getName(void) const { return "NavMeshRebakeResponder"; }
protected:
	virtual void httpSuccess();
	virtual void httpFailure();
private:
...
public:
	...
	char const* getName(void) const { return "ObjectLinksetsResponder"; }
protected:
	virtual void httpSuccess();
	virtual void httpFailure();
private:
...
public:
	...
	char const* getName(void) const { return "TerrainLinksetsResponder"; }
protected:
	virtual void httpSuccess();
	virtual void httpFailure();
private:
...
public:
	...
	char const* getName(void) const { return "CharactersResponder"; }
protected:
	virtual void httpSuccess();
	virtual void httpFailure();
private:
