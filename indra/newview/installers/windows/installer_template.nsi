...
!endif
  ...
  WriteRegStr HKLM "${MSUNINSTALL_KEY}" "HelpLink" "http://www.AllynViewer.org"
  ...
  WriteRegStr HKLM "${MSUNINSTALL_KEY}" "URLInfoAbout" "http://www.AllynViewer.org"
  WriteRegStr HKLM "${MSUNINSTALL_KEY}" "URLUpdateInfo" "http://www.AllynViewer.org/downloads"
