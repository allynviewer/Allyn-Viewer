...
{
	gToolNull = new LLTool(LLStringUtil::null);
...
void LLToolMgr::toggleBuildMode()
{
	if (!inBuildMode())
	{
		...
		if (gFocusMgr.getKeyboardFocus()) gFloaterTools->setFocus(true);
	}
	else if (gFloaterTools->getVisible() && !gFloaterTools->hasFocus() && gFocusMgr.getKeyboardFocus())
	{
