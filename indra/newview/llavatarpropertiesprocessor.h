...
#include <list>
#include <map>
constexpr U32 AVATAR_ALLOW_PUBLISH			= 0x1 << 0;
constexpr U32 AVATAR_MATURE_PUBLISH			= 0x1 << 1;
constexpr U32 AVATAR_IDENTIFIED				= 0x1 << 2;
constexpr U32 AVATAR_TRANSACTED				= 0x1 << 3;
constexpr U32 AVATAR_ONLINE					= 0x1 << 4;
constexpr U32 AVATAR_AGEVERIFIED			= 0x1 << 5;
