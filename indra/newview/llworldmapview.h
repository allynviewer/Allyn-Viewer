...
public:
	...
	virtual void	draw();
	void			drawLegacyBackgroundLayers(S32 width, S32 height);
	F32				drawLegacySimTile(LLSimInfo& sim_info, S32 left, S32 top, S32 right, S32 bottom);
...
public:
	...
	static F32		sPixelsPerMeter;
	static F32		sMapScale;
	BOOL			mItemPicked;
	static F32		sPanX;
	static F32		sPanY;
	static F32		sTargetPanX;
	static F32		sTargetPanY;
