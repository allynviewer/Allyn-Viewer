...
public:
	...
	AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return remoteParcelRequestResponder_timeout; }
	char const* getName(void) const { return "LLRemoteParcelRequestResponder"; }
protected:
