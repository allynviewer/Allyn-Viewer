...
public:
	...
	AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return viewerStatsResponder_timeout; }
	char const* getName(void) const { return "ViewerStatsResponder"; }
};
void send_stats()
{
	...
	misc["int_1"] = LLSD::Integer(unbaked_time);
	F32 grey_time = LLVOAvatar::sGreyTime * 1000.f / gFrameTimeSeconds;
	misc["int_2"] = LLSD::Integer(grey_time);
