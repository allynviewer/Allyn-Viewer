...
public:
	...
	AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return environmentRequestResponder_timeout; }
	char const* getName(void) const { return "LLEnvironmentRequestResponder"; }
private:
...
public:
	void httpSuccess(void);
	void httpFailure(void);
	AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return environmentApplyResponder_timeout; }
	char const* getName(void) const { return "LLEnvironmentApplyResponder"; }
private:
