...
public:
	...
	void	writeToAvatar(LLAvatarAppearance *avatarp);
	...
	EImportResult	importStream( std::istream& input_stream, LLAvatarAppearance* avatarp );
	class AIArchetype getArchetype() const;
	void				setParamsToDefaults();
	void				setTexturesToDefaults();
	const LLUUID		getDefaultTextureImageID(LLAvatarAppearanceDefines::ETextureIndex index) const;
	...
	void		addToBakedTextureHash(LLMD5& hash) const;
protected:
	LLAssetID			mAssetID;
