...
LLGLSLShader		gTerrainWaterProgram(LLViewerShaderMgr::SHADER_WATER);
LLGLSLShader		gWaterProgram(LLViewerShaderMgr::SHADER_WATER);
LLGLSLShader		gUnderWaterProgram(LLViewerShaderMgr::SHADER_WATER);
LLGLSLShader		gHighlightProgram(LLViewerShaderMgr::SHADER_INTERFACE);
...
LLGLSLShader			gGlowProgram(LLViewerShaderMgr::SHADER_EFFECT);
LLGLSLShader			gGlowExtractProgram(LLViewerShaderMgr::SHADER_EFFECT);
LLGLSLShader			gPostColorFilterProgram(LLViewerShaderMgr::SHADER_EFFECT);
LLGLSLShader			gPostNightVisionProgram(LLViewerShaderMgr::SHADER_EFFECT);
LLGLSLShader			gPostGaussianBlurProgram(LLViewerShaderMgr::SHADER_EFFECT);
LLGLSLShader			gPostPosterizeProgram(LLViewerShaderMgr::SHADER_EFFECT);
LLGLSLShader			gPostMotionBlurProgram(LLViewerShaderMgr::SHADER_EFFECT);
LLGLSLShader			gPostVignetteProgram(LLViewerShaderMgr::SHADER_EFFECT);
LLGLSLShader			gDeferredImpostorProgram(LLViewerShaderMgr::SHADER_DEFERRED);
LLGLSLShader			gDeferredWaterProgram(LLViewerShaderMgr::SHADER_DEFERRED);
LLGLSLShader			gDeferredUnderWaterProgram(LLViewerShaderMgr::SHADER_DEFERRED);
LLGLSLShader			gDeferredDiffuseProgram(LLViewerShaderMgr::SHADER_DEFERRED);
...
LLGLSLShader			gDeferredBumpProgram(LLViewerShaderMgr::SHADER_DEFERRED);
LLGLSLShader			gDeferredTerrainProgram(LLViewerShaderMgr::SHADER_DEFERRED);
...
LLGLSLShader			gDeferredAvatarProgram(LLViewerShaderMgr::SHADER_DEFERRED);
LLGLSLShader			gDeferredAvatarAlphaProgram(LLViewerShaderMgr::SHADER_DEFERRED);
...
LLGLSLShader			gDeferredSpotLightProgram(LLViewerShaderMgr::SHADER_DEFERRED);
LLGLSLShader			gDeferredMultiSpotLightProgram(LLViewerShaderMgr::SHADER_DEFERRED);
...
LLGLSLShader			gDeferredShadowProgram(LLViewerShaderMgr::SHADER_DEFERRED);
...
LLGLSLShader			gDeferredAvatarShadowProgram(LLViewerShaderMgr::SHADER_DEFERRED);
LLGLSLShader			gDeferredAttachmentShadowProgram(LLViewerShaderMgr::SHADER_DEFERRED);
LLGLSLShader			gDeferredAlphaProgram(LLViewerShaderMgr::SHADER_DEFERRED);
...
void LLViewerShaderMgr::setShaders()
{
	...
	if (want_shaders)
	{
		...
		if (!loaded)
		{
			llassert_always(!LLRender::sGLCoreProfile);
			unloadShaders();
		}
		else
		{
...
bool LLViewerShaderMgr::attachClassSharedShaders(LLGLSLShader& shader, S32 shader_class)
{
	switch (shader_class)
	{
...
void LLShaderMgr::unloadShaderClass(int shader_class)
{
...
std::vector<LLGLSLShader *> &LLShaderMgr::getGlobalShaderList()
{
