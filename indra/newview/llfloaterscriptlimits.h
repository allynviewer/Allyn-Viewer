...
class fetchScriptLimitsRegionInfoResponder: public LLHTTPClient::ResponderWithResult
{
	...
	public:
		AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return fetchScriptLimitsRegionInfoResponder_timeout; }
		char const* getName(void) const { return "fetchScriptLimitsRegionInfoResponder"; }
	protected:
		LLSD mInfo;
};
...
class fetchScriptLimitsRegionSummaryResponder: public LLHTTPClient::ResponderWithResult
{
	public:
		...
		void httpFailure(void);
	public:
		AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return fetchScriptLimitsRegionSummaryResponder_timeout; }
		char const* getName(void) const { return "fetchScriptLimitsRegionSummaryResponder"; }
	protected:
		LLSD mInfo;
};
...
class fetchScriptLimitsRegionDetailsResponder: public LLHTTPClient::ResponderWithResult
{
	public:
		...
		void httpFailure(void);
	public:
		AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return fetchScriptLimitsRegionDetailsResponder_timeout; }
		char const* getName(void) const { return "fetchScriptLimitsRegionDetailsResponder"; }
	protected:
		LLSD mInfo;
};
...
class fetchScriptLimitsAttachmentInfoResponder: public LLHTTPClient::ResponderWithResult
{
	public:
		...
		void httpFailure(void);
	public:
		AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return fetchScriptLimitsAttachmentInfoResponder_timeout; }
		char const* getName(void) const { return "fetchScriptLimitsAttachmentInfoResponder"; }
	protected:
};
