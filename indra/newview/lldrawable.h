...
public:
	...
	typedef enum e_drawable_flags
	{
		...
		REBUILD_VOLUME  = 0x00000800,
		REBUILD_TCOORD	= 0x00001000,
		REBUILD_COLOR	= 0x00002000,
		REBUILD_POSITION= 0x00004000,
