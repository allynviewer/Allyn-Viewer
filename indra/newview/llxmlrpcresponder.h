...
public:
	...
	bool forbidReuse(void) const { return true; }
	void received_HTTP_header(void) { mReceivedHTTPHeader = true; LLHTTPClient::ResponderBase::received_HTTP_header(); }
	...
	AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return XMLRPCResponder_timeout; }
	char const* getName(void) const { return "XMLRPCResponder"; }
};
#endif
