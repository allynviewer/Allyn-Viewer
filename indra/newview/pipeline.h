...
public:
	...
	void updateCull(LLCamera& camera, LLCullResult& result, S32 water_clip = 0, LLPlane* plane = NULL);
...
public:
	...
	static BOOL				sForceOldBakedUpload;
...
private:
	...
	LLSpatialGroup::sg_vector_t		mGroupQ1;
	LLSpatialGroup::sg_vector_t		mGroupQ2;
	LLSpatialGroup::sg_vector_t		mGroupSaveQ1;
	LLSpatialGroup::sg_vector_t		mMeshDirtyGroup;
	U32 mMeshDirtyQueryObject;
	LLDrawable::drawable_list_t		mPartitionQ;
	bool mGroupQ2Locked;
	bool mGroupQ1Locked;
