...
{
	mWidth = width ? width : 256;
	mLength = length ? length : 256;
...
void LLWorld::updateWaterObjects()
{
	...
	S32 const horizon_extend = 2048 + 512 - range;
	S32 const edge_hole_overlap = 1;
